...
private:
	...
	Value _stack[STACK_MAX]; // Runtime stack that stores values during execution
	Value *_stackTop;

	Table _globals; // Hash table that stores global variables
	ObjUpvalue *_openUpvalues; // Linked list of upvalues that has been opened
};
